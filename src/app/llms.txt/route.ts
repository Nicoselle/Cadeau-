...
export function GET() {
  const lines = [
    ...
    "",
    "## Rubrieken",
    `- Inhoudsopgave: ${SITE.url}/rubrieken`,
    `- Voorpagina: ${SITE.url}/`,
    `- Verenigde Staten: ${SITE.url}/desk/vs`,
    `- Eurozone: ${SITE.url}/desk/eurozone`,
    `- België: ${SITE.url}/desk/belgie`,
    `- Geld: ${SITE.url}/desk/geld`,
    `- Rente: ${SITE.url}/desk/rente`,
    `- Grondstoffen: ${SITE.url}/desk/grondstoffen`,
    `- Titels: ${SITE.url}/desk/titels`,
    `- De mening: ${SITE.url}/desk/opinie`,
