...
export const DOSSIERS: Dossier[] = [
  ...
  },
  {
    ...
    dek: "Puur liquide. Geen yield-jacht. De kruisen en de dollarindex zeggen wat de cash waard is in een andere eenheid — niet of we die laag mogen verlaten.",
    assetIds: ["eur", "usd", "chf", "nok"],
    drivers: [
      { tileId: "dff", relation: "Renteverschil VS–eurozone beweegt EUR/USD, dus de weging binnen de cashlaag." },
      { tileId: "hicp-ez", relation: "Eurozone-inflatie stuurt ECB-verwachting en daarmee de eurohelft." },
      { tileId: "cpi-us", relation: "Amerikaanse CPI stuurt de dollarhelft en de index." },
      { tileId: "dgs10", relation: "Renteverschil op de 10-jaars weegt op USD versus EUR, CHF, NOK." },
    ],
    channelId: "cash",
    body: [
  ...
  },
  {
    ...
    drivers: [
      { tileId: "spx", relation: "Industriële metalen ademen met cyclus en China-vraag, niet alleen met de S&P — de index is een ruwe proxy." },
      { tileId: "m2", relation: "Ruime liquiditeit tilt vaak de hele grondstoffenkant; uranium en niobium blijven smalle tapes." },
      { tileId: "vix", relation: "Dunne CSE/TSX-namen gapen harder als de VIX opspringt." },
    ],
    ...
    body: [
      ...
      "Duiding: uranium, koper en niobium hebben elk een eigen macro — kernbeleid, netcongestie, staal/legeringen — die de datavloer nog niet als CSV heeft. Die hiaat blijft zichtbaar.",
    ],
    steenman: {
      objection: "Zonder eigen uranium- of koperreeks is dit dossier headlines.",
      antwoord: "Ja, tot de vloer die reeks heeft. Daarom blijven koppen titel-bron-link, en staat de noot bij elke ticker.",
    },
  },
  {
    slug: "kasstroom",
    ...
    dek: "PBR.A, MPCC.OL, GIP.V. Hier telt het vat, de box en de installatie — en de macro die die stromen prijst.",
    assetIds: ["pbra", "mpcc", "gip"],
    drivers: [
      { tileId: "dgs10", relation: "Discontovoet op lange kasstromen. Hogere 10-jaars raakt waardering, niet per se de tanker." },
      { tileId: "cpi-us", relation: "Olie zit in de Amerikaanse CPI; de keten loopt naar Petrobras, niet omgekeerd." },
      { tileId: "m2", relation: "Wereldhandel en vracht lopen met liquiditeit en vraag, niet lineair." },
    ],
    channelId: "kasstroom",
    body: [
      "Feit: PBR-A is de preferente ADR. MPCC noteert in Oslo — vandaar NOK in de cashlaag. GIP.V is TSXV, energie- en waterinfrastructuur.",
      "Duiding: Brent, freight rates en Braziliaanse politiek staan niet in onze CSV. We volgen die koppen alleen als ze deze drie namen raken.",
    ],
    steenman: {
      objection: "Zonder olie- of vrachtreeks blijft dit een krantenknipsel.",
      antwoord: "De knipsels blijven gekoppeld aan PBR, MPCC of GIP. Geen algemene energiepagina.",
    },
  },
  {
    slug: "technologie",
...
export const ASSET_NOTES: AssetNote[] = [
  ...
  },
  {
    ...
    duiding: "Koper is elektrificatie en China-cyclus, niet de goudmacro. Eigen kanaal.",
  },
  {
    id: "nb",
  ...
  },
  {
    ...
    duiding: "Geen mijn. De macro is uraniumbeleid en de cakeprijs — ontbreekt als CSV, dus alleen gekoppelde koppen.",
  },
  {
    id: "pbra",
    ...
    duiding: "Twee macros: het vat en Brasília. Een oliestijging kan teniet door politiek. Alleen koppen die PBR, Petrobras of Brent-beleid raken.",
  },
  {
    id: "mpcc",
